...
By applying the Walktrap Community Detection on the data of 2019, we have identified 931 communities in this CRAN dependency graph. The purpose of this analysis is to show the PSV across communities. We selected the largest 20 communities for further analysis. The choice of 20 is deemed enough to show these community-specific variations. Roughly 88\% of the total 14,491 packages are covered in these the largest 20 identified communities, which shows that our analysis is based on a representative sample. Readers could explore other choices themselves using our openly shared data.  
