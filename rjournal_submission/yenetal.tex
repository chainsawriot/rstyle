...
\caption{\label{tab:}The largest 20 communities and their top 3 packages according to PageRank}
\centering
...
The data and scripts to reproduce the analysis in this paper are available at \url{https://github.com/chainsawriot/rstyle}. An archived version is available at this DOI: \url{https://doi.org/10.5281/zenodo.4016596}.
