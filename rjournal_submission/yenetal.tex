...
Using the aforementioned community detection algorithm of the dependency graph, the largest 20 communities were extracted. These communities are named by their applications. Table~\ref{tab:table2} lists the details of these communities \footnote{Recommended packages such as \CRANpkg{MASS} and \CRANpkg{survival} were included in the dependency graph. However, the PSV of recommended packages were not analyzed.}.
